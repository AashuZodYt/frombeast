...
bot = telebot.TeleBot('7342443926:AAHWvpMmYFwkK-s5gx2CTM7JWpfZVKxJwOI')
...
GROUP_ID = "-1002643293106"
CHANNEL_USERNAME = "@AASHUFREEMODZ"
...
def handle_attack(message):
    ...
    if pending_feedback.get(user_id, False):
        bot.reply_to(message, "😡 **𝐒𝐂𝐑𝐄𝐄𝐍𝐒𝐇𝐎𝐓 𝐃𝐄 𝐏𝐀𝐇𝐋𝐄!** 🔥\n🚀 *𝐀𝐆𝐋𝐀 𝐀𝐓𝐓𝐀𝐂𝐊 𝐋𝐆𝐀𝐍𝐄 𝐊𝐄 𝐋𝐈𝐘𝐄 𝐅𝐄𝐄𝐃𝐁𝐀𝐂𝐊 𝐉𝐀𝐑𝐔𝐑𝐈 𝐇𝐀𝐈!*")
        return
    ...
    if time_duration > 180:
        bot.reply_to(message, "🚫 **𝐌𝐀𝐗 𝐃𝐔𝐑𝐀𝐓𝐈𝐎𝐍 = 𝟏𝟴𝟎𝐬!**")
        return
    ...
    if profile_photos.total_count > 0:
        ...
        bot.reply_to(message, "❌ **𝐓𝐎 𝐁𝐇𝐀𝐈, 𝐏𝐑𝐎𝐅𝐈𝐋𝐄 𝐏𝐈𝐂 𝗟𝗔𝗚𝗔𝗢 𝗣𝗛𝗘𝗟𝗘!** 🔥\n📸 *𝐏𝐋𝐄𝐀𝐒𝐄 𝐒𝐄𝐓 𝐀 𝐏𝐑𝐎𝐅𝐈𝐋𝐄 𝐏𝐈𝐂𝐓𝐔𝐑𝐄 𝐓𝐎 𝐀𝐓𝐓𝐀𝐂𝐊!*")
        return
...
def handle_screenshot(message):
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝐘𝐨𝐮 𝐌𝐔𝐒𝐓 𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋𝐒 𝐅𝐈𝐑𝐒𝐓!**\n"
